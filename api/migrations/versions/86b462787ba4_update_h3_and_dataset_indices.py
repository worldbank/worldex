...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "h3_data",
        [sa.text("h3_cell_to_parent(h3_index, 7)"), "dataset_id"],
        unique=False,
        postgresql_where=sa.text("h3_get_resolution(h3_index) > 7"),
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        ...
        "h3_data",
        [sa.text("h3_cell_to_parent(h3_index, 5)")],
        unique=False,
        postgresql_where=sa.text("h3_get_resolution(h3_index) > 5"),
    )
    op.create_index(
        ...
        "h3_data",
        [sa.text("h3_cell_to_parent(h3_index, 6)")],
        unique=False,
        postgresql_where=sa.text("h3_get_resolution(h3_index) > 6"),
    )
    op.create_index(
        ...
        "h3_data",
        [sa.text("h3_cell_to_parent(h3_index, 7)")],
        unique=False,
        postgresql_where=sa.text("h3_get_resolution(h3_index) > 7"),
    )
